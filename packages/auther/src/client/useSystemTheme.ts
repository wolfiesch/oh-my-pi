...
const STORAGE_KEY = "auther-theme";
...
// Module-level store shared by the toggle (writer) and every reader so an
// explicit override and the system default resolve through one source.
