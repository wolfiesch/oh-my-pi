...
const favicon = Bun.file("./public/favicon.svg");
if (await favicon.exists()) {
	await Bun.write("./dist/client/favicon.svg", favicon);
}
...
<head>
    ...
    <title>OMP Auther</title>
    <script>
      (function () {
        try {
          var stored = localStorage.getItem("auther-theme");
