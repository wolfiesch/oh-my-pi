...
export function resolveLoaderCandidates({
	...
	if (isCompiledBinary) {
		...
		const normalizedNativeDir = nativeDir.toLowerCase();
		const workspaceDevelopment =
			!normalizedNativeDir.includes("/node_modules/") && !normalizedNativeDir.includes("\\node_modules\\");
		releaseCandidates = workspaceDevelopment
			? [...baseReleaseCandidates, ...leafCandidates]
