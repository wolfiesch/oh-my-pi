...
import { type CachedGroupedSearchResult, getSearchResultCache } from "./search-result-cache";
		...
		return untilAborted(signal, async () => {
			...
			try {
				...
				const cacheableFilesystemSearch =
					!hasLineRangeSelector && !hasArchiveParticipation && !hasInternalInput && !hasExternalInput;
